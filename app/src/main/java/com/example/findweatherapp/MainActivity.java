...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GetDataFromInternet.AsyncResponse {
    ...
    private static final String TAG = "yutyutuy";
    ...
    public void onClick(View v){
           ...
           // URL url = new URL("https://api.openweathermap.org/data/2.5/weather?q=Kazan&appid=56bf07848bec201c9a6fc857f9ed2b2b");
    ...
    private URL buildUrl (String city){
        ...
        String appid_values = "56bf07848bec201c9a6fc857f9ed2b2b";

        Uri builtUri = Uri.parse(BASE_URL).buildUpon().appendQueryParameter(PARAM_CITY, city).appendQueryParameter(PARAM_APPID, appid_values).build();
        URL url = null;
    ...
    public void proccessFinish(String output){
        ...
        try{
            ...
            String timeSunset = sys.getString("sunrise");
